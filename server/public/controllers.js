...
exports.httpSendSolana = exports.httpGetEthereumBalance = exports.httpGetSolanaBalance = exports.httpGenerateEtheriumKeypair = exports.httpGenerateSolanaKeypair = exports.httpGetSeedPhrase = exports.httpGenerateMnemonicPhrase = void 0;
...
const httpGetSolanaBalance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield axios_1.default.post(_1.solanaDevnet, {
        "jsonrpc": "2.0",
        "id": 1,
        "method": "getBalance",
        "params": [`${publickey}`]
    ...
    return res.send({
        balance: parseFloat(response.data.result.value) / web3_js_1.LAMPORTS_PER_SOL
    }).status(200);
});
...
const httpGetEthereumBalance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { publickey } = req.body;
    const response = yield axios_1.default.post("https://eth-sepolia.g.alchemy.com/v2/42KkGIbztI2javG6kfsiiPC5547UMGlf", {
        "jsonrpc": "2.0",
        "id": 1,
...
const httpSendSolana = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { toPublicKey, fromPublicKey, fromPrivateKey, sol } = req.body;
    try {
        const connection = new web3_js_1.Connection('https://api.devnet.solana.com/', 'confirmed');
        const sender = web3_js_1.Keypair.fromSecretKey(bs58_1.default.decode(fromPrivateKey));
        ...
        const signature = yield (0, web3_js_1.sendAndConfirmTransaction)(connection, transaction, [sender], {
            skipPreflight: false,
...
exports.httpSendSolana = httpSendSolana;
